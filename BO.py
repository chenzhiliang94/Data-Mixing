...
def iterative_loop(data_sources : List[DataLoader], validation_data : DataLoader, num_epochs=10, iterations=10, method="mixing_ratio", data="images", printout=True):
    ...
    for i in range(iterations):
        ...
        if data=="images":
            acc_all, observed_performance, _ = train(mixed_data, validation_data, num_epochs=num_epochs, printout=printout) # observe the performance of this dataset from finetuning
